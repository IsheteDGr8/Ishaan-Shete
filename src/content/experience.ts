...
export const roles: Role[] = [
  {
    ...
    highlights: [
      ...
      "Connected a Python FastAPI backend, a Next.js frontend and Azure Cosmos DB to automate résumé screening, ticketing and compliance tracking, with strict PII redaction.",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Directed club operations and ran 11 events for 1,200+ attendees.",
    ],
    projectSlugs: ["cricky"],
  },
  {
    ...
    title: "Teaching Assistant, CSS 475 Database Systems",
    start: "Mar 2026",
    end: "Jun 2026",
    highlights: [
